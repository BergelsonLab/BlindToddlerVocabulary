...
\hline
(Intercept) & -6.35 [-7.92, -4.78] & < .001***\\
\hline
Modality (visual) & -0.33 [-1.57, 0.91] & .598\\
\hline
Perceptual Strength & 0.92 [0.69, 1.15] & < .001***\\
\hline
Group (blind) & 0.34 [-1.53, 2.20] & .723\\
\hline
...
\hline
Modality (visual) & -0.04 [-0.95, 0.87] & .931\\
\hline
Perceptual Exclusivity & 0.93 [-1.05, 2.91] & .358\\
\hline
Group (blind) & 0.22 [-1.59, 2.03] & .809\\
\hline
Modality (visual) × Perceptual Exclusivity & -0.37 [-2.71, 1.97] & .757\\
\hline
