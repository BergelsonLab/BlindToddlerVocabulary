...
} else
{
  ...
  VITD_vocabmatches_wordlevel <-
    read.csv("./data/CDI/Derived/VITD_vocabmatches_wordlevel.csv")
...
```{r longitudinal-plot, fig.cap="Vocabulary delay in blind children plotted as a function of age. Raw data are plotted in color. Each dot represents one CDI administration. When participants have multiple administrations of the CDI, lines connect datapoints from the same participant at multiple timepoints. Black dashed line represents the model estimate with standard error: Vocabulary Delay ~ Age + (1|Participant)."}
longitudinal_plot
```
